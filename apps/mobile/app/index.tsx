...
export default function WelcomeScreen() {
  ...
  return <Screen>
    ...
    <View style={styles.footer}><Text style={styles.safety}>{language === 'en' ? 'Not a substitute for emergency services' : 'आपतकालीन सेवाको विकल्प होइन'}</Text><Pressable onPress={start} style={uiStyles.primaryButton}><Text style={uiStyles.primaryButtonText}>{step === 0 ? (language === 'en' ? 'Get started' : 'सुरु गर्नुहोस्') : (language === 'en' ? 'Continue in this language' : 'यही भाषामा अघि बढ्नुहोस्')}</Text></Pressable></View>
  </Screen>;
}
