...
export default function WelcomeScreen() {
  ...
  return <Screen>
    ...
    <View style={styles.hero}><SathiOrb size={96} /><Text style={uiStyles.h1}>{step === 0 ? 'स्वास्थ्य सेवा, अब एक–एक सजिलो कदममा।' : 'कुन भाषामा सहज हुन्छ?'}</Text><Text style={uiStyles.body}>{step === 0 ? 'प्रश्न बुझ्ने, सुरक्षित अर्को कदम देखाउने र सही स्वास्थ्य सेवासँग जोड्ने तपाईंको साथी।' : 'पछि जुनसुकै बेला भाषा परिवर्तन गर्न सक्नुहुन्छ।'}</Text></View>
