...
export function TextEntryToggle({ toggleLabel, promoted, placeholder, submitLabel, onSubmit }: TextEntryToggleProps) {
  ...
  return (
    <div className="mt-2 flex w-full max-w-sm flex-col items-center">
      ...
      >
        <input
          className="min-h-11 flex-1 rounded-pill border border-line bg-white px-4 text-sm text-ink placeholder:text-ink-soft focus:border-indigo-400 focus:outline-none"
