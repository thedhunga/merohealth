...
export function MemberRouting({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <rect fill="#FFFCF7" height="70" rx="10" stroke="#221C4B" strokeWidth="4" width="104" x="26" y="52" />
      <circle cx="50" cy="76" fill="#221C4B" fillOpacity="0.18" r="12" />
      <rect fill="#221C4B" fillOpacity="0.22" height="6" rx="3" width="46" x="70" y="66" />
      <rect fill="#221C4B" fillOpacity="0.16" height="6" rx="3" width="34" x="70" y="80" />
      ...
      <circle cx="204" cy="80" fill="#221C4B" r="24" />
      <path
