...
export function HomeFirstVisit({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M90 60 L120 36 L150 60 Z" fill="#0A3628" stroke="#A9DFC9" strokeLinejoin="round" strokeWidth="4" />
      <rect fill="#0A3628" height="50" stroke="#A9DFC9" strokeWidth="4" width="60" x="90" y="60" />
      <rect fill="#FFFCF7" height="24" stroke="#A9DFC9" strokeWidth="2" width="16" x="112" y="86" />
