...
export function WorkplaceInvestment({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <rect fill="#FFFCF7" height="96" rx="10" stroke="#221C4B" strokeWidth="4" width="188" x="26" y="32" />
      <path d="M26 60 L214 60" stroke="#221C4B" strokeOpacity="0.2" strokeWidth="2" />

      {/* Rising bars: the investment compounding over time. */}
      <rect fill="#221C4B" fillOpacity="0.2" height="24" rx="4" width="18" x="52" y="88" />
      <rect fill="#221C4B" fillOpacity="0.3" height="38" rx="4" width="18" x="82" y="74" />
      <rect fill="#3D3480" height="54" rx="4" width="18" x="112" y="58" />
      <rect fill="#3D3480" height="70" rx="4" width="18" x="142" y="42" />
